...
DB_CONFIG = {
    ...
    "dbname": "postgres",
    "user": "postgres",
    "password": "Arja200507$$",   # <-- same password as your other scripts
}

TARGET_STATE = "West Bengal"   # <-- change this to run a different state
HOUSE_ID = "2"                 # 2 = Lok Sabha (we haven't confirmed the Rajya Sabha code yet)
