...
def main():
    ...
    try:
        for work_id, stages in sorted(grouped.items()):
            ...
            # "final_amount" = best-known approved figure. Sanction amount is the most
            # authoritative official figure once it exists; fall back to recommended
            # amount if the work hasn't been sanctioned yet.
